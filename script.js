...
var UI = /** @class */ (function () {
    ...
    UI.prototype.renderCell = function () {
        ...
        __spreadArray([], this.wrapper.children, true).forEach(function (cell, idx) {
    ...
    UI.prototype.handlerReload = function () {
        ...
        this.reloadElm.addEventListener("click", function () {
            __spreadArray([], _this.wrapper.children, true).forEach(function (cell) { return cell.remove(); });
            setTimeout(function () {
                _this.renderCell();
            }, 100);
            _this.cardElm.textContent = "";
